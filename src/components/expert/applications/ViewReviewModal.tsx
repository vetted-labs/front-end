...
import { X, CheckCircle, XCircle, Loader2, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="flex min-h-full items-center justify-center p-3 sm:p-4">
        <div
          className="relative w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden rounded-2xl border border-border/60 bg-card shadow-sm dark:bg-card/40 dark:backdrop-blur-xl dark:border-white/[0.06]"
