...
export default function JobQuestionsStep({
  ...
  const activeScreeningQuestion =
    promptIndex !== null ? screeningQuestions[promptIndex] ?? null : null;
  ...
  return (
    <div className="space-y-10">
      ...
      {/* Screening questions — legacy full list (no substep slicing) */}
      ...
      {/* Screening question — single substep slice */}
      {!isSetupSubstep && promptIndex !== null && activeScreeningQuestion && (
        <section>
          <SectionHeader
            title={
              <span className="inline-flex items-center gap-2">
          ...
          <div className="space-y-3">
            ...
            <Textarea
              ...
              onChange={(e) =>
                onScreeningAnswerChange(promptIndex, e.target.value)
              }
              rows={4}
              placeholder="Your answer…"
            />
