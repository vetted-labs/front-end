// e2e/real-flow/scenarios/02-reject-consensus.spec.ts
//
// Suite A — Scenario 02: reject-consensus.
//
// Canonical happy path that exercises the entire commit-reveal vetting loop
// end-to-end: candidate applies via the UI, three panelists commit low
...
test("reject consensus: 3 panelists reveal low → rejected", async ({
  page,
  candidate,
  guild,
  experts,
